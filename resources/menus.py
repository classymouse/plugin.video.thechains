...
def main_menu():
    ...
    aa=addDir3('Chain Reaction','https://thechains24.com/ONE%20CLICK%20CHAINS/MAIN%20DIR.txt',189,'https://i.imgur.com/2lK5flU.png','https://i.imgur.com/GqkMiYJ.png','Chain Reaction')
    all_d.append(aa)
    #place your Jen playlist here:
    #dulpicate this line with your address
